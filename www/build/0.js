...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__receive__ = __webpack_require__(300);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_qrcode2__ = __webpack_require__(301);
...
var ReceivePageModule = /** @class */ (function () {
    function ReceivePageModule() {
    }
    ReceivePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__receive__["a" /* ReceivePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__receive__["a" /* ReceivePage */]),
                __WEBPACK_IMPORTED_MODULE_3_ngx_qrcode2__["a" /* NgxQRCodeModule */]
            ],
        })
    ], ReceivePageModule);
    return ReceivePageModule;
}());
...
var Version = __webpack_require__(294)
var Regex = __webpack_require__(295)
...
var ECLevel = __webpack_require__(292)
...
var ECCode = __webpack_require__(293)
var ECLevel = __webpack_require__(292)
var Mode = __webpack_require__(288)
var isArray = __webpack_require__(291)
...
var ReceivePage = /** @class */ (function () {
    function ReceivePage(navCtrl, navParams, userData, alertCtrl, restApiService, loadingCtrl, storage) {
        this.navCtrl = navCtrl;
    ...
    ReceivePage.prototype.ionViewDidLeave = function () {
        console.log("calling leave");
        clearInterval(this.refreshIntervalId);
    };
    ReceivePage.prototype.generateQRCode = function () {
        var self = this;
    ...
    ReceivePage.prototype.redirectToHome = function () {
        this.restApiService.updateBalance();
        this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_5__home_home__["a" /* HomePage */]);
    };
    ReceivePage.prototype.validatePayment = function () {
        var self = this;
        console.log("Receiver name---" + self.userData.receiverUserName);
        console.log("uniqueTransactionId---" + self.userData.transactionId);
        var vaidateJsonMsg = { "uniqueTransactionId": self.userData.transactionId };
        return new Promise(function (resolve, reject) {
            self.restApiService.makeBackendPostRequest(__WEBPACK_IMPORTED_MODULE_4__config_app_config__["a" /* AppConfig */].VALIDATE_TRANSACTION, null, JSON.stringify(vaidateJsonMsg)).then(function (result) {
    ...
    ReceivePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-receive',template:/*ion-inline-start:"/Users/ram/Ram/Workarea/Projects/E-Wallet/src/pages/receive/receive.html"*/'<!--\n  Generated template for the ReceivePage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n  <ion-navbar>\n    <ion-title>Receive</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <div *ngIf="!isPaymentReceived">\n    <ion-card *ngIf="qrCodeCreated">\n      <ion-title>Scan the QRCode to complete the transaction</ion-title>\n      <ngx-qrcode qrc-element-type="img" [qrc-value]="userData.createdCode"></ngx-qrcode>\n\n    </ion-card>\n    <div id="hideQRCode" *ngIf="!qrCodeCreated">\n      <ion-title>Please enter the amount you want to receive</ion-title>\n      <ion-item>\n        <ion-input type="tel" maxlength="5" placeholder="AED 0.00" [(ngModel)]="userData.amount" name="amount"></ion-input>\n      </ion-item>\n      <ion-item>\n          <ion-input type="text" maxlength="200" placeholder="Remarks" [(ngModel)]="userData.remarks" name="remarks"></ion-input>\n        </ion-item>\n      <button class="wallet-button" (click)="generateQRCode()">\n        <ion-title>Proceed</ion-title>\n      </button>\n    </div>\n  </div>\n  <div *ngIf="isPaymentReceived">\n    <ion-col>\n      <img class="center" src="assets/images/success.png" />\n    </ion-col>\n    <p class="success">Received Successfully</p>\n    <ion-row>\n      <ion-col>\n        <ion-item>Amount</ion-item>\n      </ion-col>\n      <ion-col>\n        <ion-item>AED {{userData.amount}}</ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-item>From</ion-item>\n      </ion-col>\n\n      <ion-col>\n        <ion-item>{{userData.receiverUserName}}</ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-item>To</ion-item>\n      </ion-col>\n\n      <ion-col>\n        <ion-item>{{userData.loggedInUserName}}</ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-item>Remarks</ion-item>\n      </ion-col>\n\n      <ion-col>\n        <ion-item></ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-item>Transaction ID</ion-item>\n      </ion-col>\n      <ion-col>\n        <ion-item>{{userData.transactionId}}</ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col>\n        <ion-item>Transaction Date</ion-item>\n      </ion-col>\n      <ion-col>\n        <ion-item>{{userData.transactionDate}}</ion-item>\n      </ion-col>\n    </ion-row>\n    <button class="wallet-button" (click)="redirectToHome()" name="done">\n      <ion-title>Done</ion-title>\n    </button>\n  </div>\n\n</ion-content>'/*ion-inline-end:"/Users/ram/Ram/Workarea/Projects/E-Wallet/src/pages/receive/receive.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__providers_transactionModel__["a" /* TransactionModel */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
            __WEBPACK_IMPORTED_MODULE_3__providers_restapi_service__["a" /* RestAPIServiceProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_6__ionic_storage__["b" /* Storage */]])
    ], ReceivePage);
    return ReceivePage;
}());
 ...
 */
var QRCode = __webpack_require__(302);
...
var QRCode = __webpack_require__(303)
var CanvasRenderer = __webpack_require__(319)
var SvgRenderer = __webpack_require__(320)
...
var Buffer = __webpack_require__(289)
var Utils = __webpack_require__(287)
var ECLevel = __webpack_require__(292)
var BitBuffer = __webpack_require__(304)
var BitMatrix = __webpack_require__(305)
var AlignmentPattern = __webpack_require__(306)
var FinderPattern = __webpack_require__(307)
var MaskPattern = __webpack_require__(308)
var ECCode = __webpack_require__(293)
var ReedSolomonEncoder = __webpack_require__(309)
var Version = __webpack_require__(294)
var FormatInfo = __webpack_require__(312)
var Mode = __webpack_require__(288)
var Segments = __webpack_require__(313)
var isArray = __webpack_require__(291)
...
var getSymbolSize = __webpack_require__(287).getSymbolSize
...
var Buffer = __webpack_require__(289)
var Polynomial = __webpack_require__(310)
...
var Buffer = __webpack_require__(289)
var GF = __webpack_require__(311)
...
var Mode = __webpack_require__(288)
var NumericData = __webpack_require__(314)
var AlphanumericData = __webpack_require__(315)
var ByteData = __webpack_require__(316)
var KanjiData = __webpack_require__(317)
var Regex = __webpack_require__(295)
var Utils = __webpack_require__(287)
